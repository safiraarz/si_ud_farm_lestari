...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'akuntansi' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_AKUNTANSI'),
            'host' => env('DB_HOST_AKUNTANSI', '127.0.0.1'),
            'port' => env('DB_PORT_AKUNTANSI', '3306'),
            'database' => env('DB_DATABASE_AKUNTANSI', 'forge'),
            'username' => env('DB_USERNAME_AKUNTANSI', 'forge'),
            'password' => env('DB_PASSWORD_AKUNTANSI', ''),
            'unix_socket' => env('DB_SOCKET_AKUNTANSI', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
