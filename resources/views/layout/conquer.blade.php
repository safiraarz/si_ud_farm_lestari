				...
				<ul class="page-sidebar-menu">
					...
					<li>
						...
						<ul class="sub-menu blank">
							...
							<li>
								<a href="{{route('flok.index')}}">
									<span class="title">Flok Ayam</span>
								</a>
							</li>
							<li>
							...
							<li>
								<a href="{{route('daftarakun.index')}}">
									<span class="title">Daftar Akun</span>
								</a>
							</li>
						</ul>
					</li>
					<li>
						<a href="#">
							<span class="link_name">Daftar Transaksi</span>
						</a>
						<ul class="sub-menu blank">
							<li>
								<a href="{{route('notapemesanan.index')}}">
									<span class="title">Nota Pemesanan Bahan Baku</span>
								</a>
							</li>
							<li>
								<a href="{{route('notapembelian.index')}}">
									<span class="title">Nota Pembelian Bahan Baku</span>
								</a>
							</li>
							<li>
								<a href="{{route('pemasukantelur.index')}}">
									<span class="title">Daftar Pemasukan Telur</span>
								</a>
							</li>
							<li>
							...
							<li>
								...
								<a href="{{route('jadwalpakan.index')}}">
									<span class="title">Jadwal Pemberian Pakan</span>
								</a>
							</li>
						</ul>
					</li>
						...
						<ul class="sub-menu blank">
							...
							<li>
								<a href="{{route('spk.index')}}">
									<span class="title">Surat Perintah Kerja</span>
								</a>
							</li>
							<li>
								<a href="{{route('mps.index')}}">
									<span class="title">Master Production Schedule</span>
								</a>
							</li>
							<li>
								<a href="{{route('mrp.index')}}">
									<span class="title">Material Requirement Planning</span>
								</a>
							</li>
							<li>
							...
							<li>
								<a href="{{route('hasilproduksi.index')}}">
									<span class="title">Daftar Hasil Produksi</span>
								</a>
							</li>
							<li>
					...
					<li>
						<a href="#">
							<!-- <i class="icon-home"></i> -->
							<span class="link_name">Laporan Jurnal</span>
						</a>
						<ul class="sub-menu blank">
							<li>
								<a>
