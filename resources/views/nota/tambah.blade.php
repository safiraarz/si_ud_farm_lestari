                ...
                <table class="table" style="background-color:#e0e0e0;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="number" id="kuantitas" min="0" value="0" class="form-control kuantitas">
                            </td>
                            <td>
                                <input type="number" id="harga" min="0" value="0" class="form-control harga">
                            </td>
            ...
            <form action="{{ route('notapembelian.store') }}"  method="post" enctype="multipart/form-data"
                ...
                <div class="form-body" >
                    ...
                    <div class="form-group ">
                        ...
                        <div>
                            <input type="date" value="{{ $date_now }}" name="tanggal_pembuatan_nota" class="form-control input-sm" required />
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <table class="table" style="background-color:#e0e0e0;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="number" id="kuantitas_penjualan" min="0" value="0" class="form-control kuantitas">
                            </td>
                            <td>
                                <input type="number" id="harga_penjualan" min="0" value="0" class="form-control harga">
                            </td>
            ...
            <div class="col-md-7  mt-4" style="background-color:#f5f5f5;">
                <form action="{{ route('notapenjualan.store') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="p-4">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 ">
                                <span>No. Nota</span> : <span id="no_nota_penjualan_span">{{ $no_nota_penjualan }}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 ">
                                <span>Tanggal Transaksi</span> : <span id="tgl_transaksi_penjualan_span">{{ $date_now }}</span>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
...
<script>
    ...
    $('#tambah_pemesanan').on('click', function() {
        ...
        notapemesanan.forEach(element => {
            if (id_nota_pesanan == element[0]) {
                // Show Supplier
                var supplier_html = '<div class="form-group p-3"><label>Nama Supplier</label><select class="form-control" name="supplier_id" id="supplier"  readonly><option value="' + element[1][0] + '" >' + element[1][1] + '</option></select></div>' ;

                $('#bahan_pesanan').append(supplier_html);
                $('#bahan_pesanan').append('<div id="bahan_pesanan_row" class="row justify-content-around"></div>');
                        ...
                        // '<div class="row">'+
                            '<div class="col-md-3">'+
                                ...
                                '<div class="form-group">'+
                                    ...
                                    '<input type="hidden" name="barang[' + index + '][' + "barang_id" + ']" class="form-control" id="harga" value="' + barang_id + '" required  readonly>'+
                                    '</div>' +
                                '<div class="form-group"><label>Harga per-satuan : '+harga+'</label>'+
                            '<input type="hidden" name="barang[' + index + '][' + "harga" + ']" class="form-control" id="harga" value="' + harga + '" required  readonly>'+
                        '</div>' +
                        '<div class="form-group"><label>Kuantitas</label><input type="number" name="barang[' + index + '][' + "kuantitas" + ']" class="form-control" id="kuantitas" value="' + kuantitas + '" required></div>'+
                        '</div>' +
                        '</div>';
    ...
    $('#tambah_penjualan').on('click', function() {
            ...
            function billFunction() {
                ...
                var notainput = '<input type="hidden" name="no_nota_penjualan" value=' + no_nota + '> ' + '<input type="hidden" name="tgl_transaksi" value=' + tgl_transaksi + '> ' + '<input type="hidden" name="customer_id" value=' + id_customer + '> ';
                ...
                $("#receipt_bill_penjualan").each(function() {
                    ...
                    var table = '<tr><td>' + count_penjualan + '</td><td>' + name + '<input type="hidden" name="barang_penjualan[' + count_penjualan + '][' + "id_barang" + ']" value=' + id_barang + '></td><td>' + kuantitas + '<input type="hidden" name="barang_penjualan[' + count_penjualan + '][' + "kuantitas" + ']" value=' + kuantitas + '></td><td>' + satuan + '</td><td>' + harga + '<input type="hidden" name="barang_penjualan[' + count_penjualan + '][' + "harga_barang" + ']" value=' + harga + '></td><td><strong><input type="hidden" id="total" name="barang_penjualan[' + count_penjualan + '][' + "total_harga_barang" + ']" value="' + total + '">' + total + '</strong></td></tr>';
                ...
                for (let index = 0; index < element[2].length; index++) {
                    ...
                    var barang_pesanan =
                        // '<div class="row">'+
                            ...
                            '<input type="number" name="barang[' + index + '][' + "harga" + ']" class="form-control" id="harga" value="' + harga + '" required >'+
                        '</div>' +
                        '<div class="form-group"><label>Kuantitas</label><input type="number" name="barang[' + index + '][' + "kuantitas" + ']" class="form-control" id="kuantitas" value="' + kuantitas + '" required></div>'+
                        '</div>' +
                        '</div>';
