            ...
            <div class="col-md-7  mt-4" style="background-color:#f5f5f5;">
                <form action="{{ route('notapenjualan.store') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="p-4">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 ">
                                <span>No. Nota</span> : <span id="no_nota_penjualan_span">{{ $no_nota_penjualan
                                    }}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 ">
                                <span>Tanggal Transaksi</span> : <span id="tgl_transaksi_penjualan_span">{{ $date_now
                                    }}</span>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
            ...
            function billFunction() {
                ...
                $("#receipt_bill").each(function() {
                    var table = '<tr class="list" id="row_' + id_barang + '" harga="' + total_pesanan + '"><td>' +
                        ...
                        '></td><td ><strong id="label_total_' + id_barang + '"><input id="form_total_' + id_barang + '" type="hidden" id="total" value="' + total_pesanan + '">' +
                        thousands_separators(total_pesanan) +
                        '</strong></td>' +
                        '<td>' +
                        '<a class="btn btn-danger barang_delete" onclick="deleteDataPemesanan(' + id_barang  +
                ...
                if (id_nota_pesanan == element[0]) {
                    ...
                    for (let index = 0; index < element[2].length; index++) {
                        ...
                        var table = '<tr class="list" id="row_' + index + '">' +
                            ...
                            '<td>' +
                            '<input class="kuantitas_pembelian" id="kuantitas_' + index + '" type="number" onchange="maxminvalue(' +
                            "'kuantitas'" + "," + index + "," + kuantitas + '),findTotalPembelian()" min="1" max="' + kuantitas +
                            '" name="barang[' + index + '][' + "kuantitas" + ']" value=' +
                            thousands_separators(kuantitas) + '>' +
                            '</td>' +
                            '<td>' +
                            '<input class="harga_pembelian" id="harga_' + index + '" type="number" onchange="maxminvalue(' +
                            "'harga'" + "," + index + "," + harga + '),findTotalPembelian()"  min="1" max="' + harga +
            ...
            function billFunction() {
                ...
                $("#receipt_bill_penjualan").each(function() {
                    ...
                    var table = '<tr id="row_' + id_barang + '" harga="' + total + '" ><td>' + name +
                        ...
                        "harga_barang" + ']" value=' + harga +
                        '></td>'+
                        '<td><strong id="label_penjualan_total_' + id_barang + '"><input id="form_penjualan_total_' + id_barang + '" type="hidden" id="total" name="barang_penjualan[' +
