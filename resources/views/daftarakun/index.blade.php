            ...
            <table id='myTable' class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr id='tr_{{$d->id}}'>
                        ...
                        <td>{{$d->nama}}</td>
                        <td>{{$d->jenis_akun}}</td>
                        <td>Rp{{number_format($d->saldo_normal,2)}}</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('daftarakun') }}" class="form-horizontal" method='POST'>
                    @csrf
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="strain" class="form-control" id='strain' required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <div class="col-md-offset-3 col-md-9">
                            <button type="submit" class="btn btn-success">Submit</button>
                            <a href="{{url('daftarakun')}}" class="btn btn-default" data-dismiss="modal">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
